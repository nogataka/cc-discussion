#!/bin/bash
cd "$(dirname "$0")"
# Claude Discussion Room Launcher for Unix/Linux/macOS
# This script launches the web UI for multi-Claude discussions.

echo ""
echo "===================================="
echo "  Claude Discussion Room"
echo "===================================="
echo ""
...
if ! command -v claude &> /dev/null; then
    ...
    echo ""
    echo "    The discussion orchestrator requires Claude CLI to work."
